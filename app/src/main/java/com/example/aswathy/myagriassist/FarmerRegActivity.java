...
public class FarmerRegActivity extends AppCompatActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener, CompoundButton.OnCheckedChangeListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancel = (Button) findViewById(R.id.btncancelf);
...
//            pla = adapterView.getItemAtPosition(i).toString();
        ...
        if (adapterView == quali) {
           ...
           // Toast.makeText(FarmerRegActivity.this, "text" + "item" + qualif, Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(String s) {
           ...
           // Toast.makeText(FarmerRegActivity.this, "NO place" + s, Toast.LENGTH_LONG).show();
            ...
            try {
                ...
                adapter = new ArrayAdapter<String>(FarmerRegActivity.this, android.R.layout.simple_spinner_item, places);
    ...
    private class selstate extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            super.onPostExecute(s);
           // Toast.makeText(FarmerRegActivity.this, "No Value" + s, Toast.LENGTH_LONG).show();
            JSONArray j;
            try {
                j = new JSONArray(s);
                JSONObject obj;
                ...
                adapter = new ArrayAdapter<String>(FarmerRegActivity.this, android.R.layout.simple_spinner_item, states);
                adapter.setDropDownViewResource(android.R.layout.simple_spinner_item);
        ...
        protected void onPostExecute(String s) {
           ...
           // Toast.makeText(FarmerRegActivity.this, " No Dist" + s, Toast.LENGTH_LONG).show();
            ...
            try {
                ...
                adapter = new ArrayAdapter<String>(FarmerRegActivity.this, android.R.layout.simple_spinner_item, dists);
                adapter.setDropDownViewResource(android.R.layout.simple_spinner_item);
    ...
    private class insertData extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            WebServiceCaller web = new WebServiceCaller();
            web.setSoapObject("register");
            web.addProperty("fname", strings[0]);
            web.addProperty("lname", strings[1]);
        ...
        protected void onPostExecute(String s) {
            super.onPostExecute(s);
            Toast.makeText(FarmerRegActivity.this,""+s,Toast.LENGTH_LONG).show();
            if (s.equals("Sucess"))
            {
                Intent i=new Intent(FarmerRegActivity.this,LoginActivity.class);
                startActivity(i);
                Toast.makeText(FarmerRegActivity.this,"Register Successful",Toast.LENGTH_LONG).show();
            }
        ...
        protected void onPostExecute(String s) {
           ...
           // Toast.makeText(FarmerRegActivity.this,"No QUali"+ s, Toast.LENGTH_LONG).show();
            ...
            try {
                ...
                adapter = new ArrayAdapter<String>(FarmerRegActivity.this, android.R.layout.simple_spinner_item,qualification);
                adapter.setDropDownViewResource(android.R.layout.simple_spinner_item);
